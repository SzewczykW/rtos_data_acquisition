...
//     <i>  - Thread functions: osThreadGetClass, osThreadSuspendClass,
//     osThreadResumeClass
...
//     <o>Total Stack size [bytes] for user Threads with user-provided Stack size
//     <0-1073741824:8> <i> Defines the combined stack size for user threads with
//     user-provided stack size. <i> Applies to user threads with user-provided stack
//     size and system provided memory for stack. <i> Default: 0
